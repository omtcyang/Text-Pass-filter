...
def ohem_single(score, gt_text, training_mask):
    ...
    pos_num = int(torch.sum(gt_text > 0.5))
    ...
    # print(torch.sum(((score >= threshold) & (training_mask >= 0.5))),torch.sum((gt_text > 0.5) & (training_mask > 0.5)))

    selected_mask = (((score >= threshold) & (training_mask >= 0.5)) | ((gt_text > 0.5)) & (training_mask > 0.5))
